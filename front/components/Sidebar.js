...
export default function Sidebar({ isGuest = false, onNewChat, onSelectChat, newChatTrigger, refreshSessionList, theme = "blue" }) {
        ...
        <aside className={`${styles.sidebar} theme-${theme}`}>
            <div>
                <div onClick={() => window.location.reload()} className={styles.logo}>
                    <img
                        src={`/logos/logo-${theme}.png`}
                        alt="Sound of Mind Logo"
